...
// Fraction of vertical velocity kept after a front-wall bounce. Too low and
// every shot's arc gets crushed flat the instant it touches the wall, so the
// ball never has real hang time — it just sits low (easy to smash down) and
// dies before reaching the back of the court. 0.6 keeps a real arc alive.
export const FRONT_WALL_Y_DAMP = 0.6;
